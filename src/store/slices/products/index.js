...
const DEFAULT_STATE = [
	{
		_id: "6413203fb2285084f799a73a",

		codigo: "87",
		prenda: "VESTIDO ROJO LARGO",
		marca: "SIN",
		categoria: "",
		cliente: "SILVINA CARRIZO",
		precioVenta: "4660",
		estado: "local",
		tiempoEnVenta: "",
	},
...
// export const updateProduct = createAsyncThunk("products/updateProduct", async ({ _id, formData }) => {
// 	try {
// 		await axios({
// 			url: `${baseUrl}/product/${_id}`,
// 			method: "PATCH",
...
export const { deleteProductById } = productSlice.actions;
